...
function App({students}: Students) {
    ...
    function joinAnswers(studentId: string) {
        ...
        if (!!answer) return answer.answers.map(_ => _ === '' ? "''" : _).join(", ");
        return '';
    }
            ...
            <table>
                ...
                {students.map((_ : Student) => {
                    ...
                    <tr key={_.student.studentId}>
                        ...
                        <td>{config.studentPortalUrl}/{_.student.studentId}</td>
                        <td 
                            data-testid={_.student.studentId + '-answers'}
                        >
